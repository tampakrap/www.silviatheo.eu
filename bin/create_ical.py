...
for lang in LANGS:
    ...
    preparty.add('dtend', datetime(2021,7,10,1,0,0,tzinfo=TZ_ES))
    ...
    transportation.add('dtstart', datetime(2021,7,10,18,0,0,tzinfo=TZ_ES))
    transportation.add('dtend', datetime(2021,7,10,18,30,0,tzinfo=TZ_ES))
